...
import { Agenda, Clock, CurrentWeather as CurrentWeatherBis, DailyForecastWeather, Draft as DraftBis, HourlyForecastWeather, Lists, Switch, Test, TodayDate, TodayPrecipitation, TodayTemp, WeatherLocation } from '../components/modules';
...
export type Module = ModuleProps | WeatherLocationProps | ListsProps | AgendaProps | DraftProps;
...
export type ModuleDetailType = FC<ModuleProps> | FC<WeatherLocationProps> | FC<ListsProps> | FC<AgendaProps> | FC<DraftProps>;
...
export interface Modules {
    ...
    Test: (props: ModuleProps) => JSX.Element;
}